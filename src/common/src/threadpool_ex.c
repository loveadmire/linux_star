...
#define MIN_WAIT_TASK_NUM 100 // if queue_size > MIN_WAIT_TASK_NUM, we need add thread
#define DEFAULT_THREAD_VARY 100 //# of thread num vary
...
int test_thread_ex(int min,int max)
{
	threadpool_t *thp = threadpool_create(min,max,80);
	printf("pool inited");
